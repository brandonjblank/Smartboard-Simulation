...
public class ProjectController implements Serializable {
    ...
    @EJB private Session.ProjectFacade ejbFacade;
    ...
    public int getLatestProject() {
        int var = ejbFacade.count() +1;               
        return var;
    }
    
    public List<Project> getProjectSlides(java.lang.Integer id) {
        
        return ejbFacade.getSlideList(id);
    }
